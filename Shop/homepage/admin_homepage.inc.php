...
require_once 'admin_function/dbh.inc.php';
require_once 'admin_homepage_model.inc.php';
require_once 'admin_homepage_contr.inc.php';
    ...
    <div class="content">
        ...
        <div class="dashboard">
                    ...
                    <ul class="order-list">
                        <?php foreach ($new_orders as $order): ?>
                            <li>
                                ...
                                <form method="POST" action="admin_function/update_tracking_info_details.inc.php">
            ...
            <div class="dashboard-section">
                ...
                <?php endif; ?>
                <a class="inbox-button" href="admin_function/inbox_details.inc.php">Go to Inbox</a>
            </div>

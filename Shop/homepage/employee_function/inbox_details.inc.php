...
<body>
    ...
    <div class="content">
        <div class="container">
            ...
            <?php 
            if ($unread_unactioned_messages = get_unread_unactioned_messages($pdo)) {
            ...
            if ($read_unactioned_messages = get_read_unactioned_messages($pdo)){ 
            ...
            if ($read_actioned_messages = get_read_actioned_messages($pdo)){ 
                ...
                echo '<h4>You are all caught up!!</h4>';
            }
            ?>
